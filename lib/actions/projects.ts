...
export async function getProjects(params?: GetProjectsRequest): Promise<{ success: boolean; projects?: Project[]; meta?: GetProjectsResponse['meta']; error?: Error }> {
    ...
    if (result.success && result.response) {
        try {
            ...
            return { success: true, projects, meta: data.meta }
        } catch {
