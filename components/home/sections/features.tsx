                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                    {services.map(({ name, description, icon: Icon }, index) => (
                        <div
                            key={index}
                            className={cn(
                                "flex flex-col gap-y-2 items-center justify-center py-8 px-4 border-b transition-colors hover:bg-muted",
                                "last:border-b-0",
                        ...
                        >
                            ...
                            <Link
                                href="#"
                                className="text-sm text-primary hover:underline underline-offset-4 transition-colors hover:text-muted-foreground"
                            >
                                Learn more &gt;
                            </Link>
                        </div>
