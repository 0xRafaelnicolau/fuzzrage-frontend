                ...
                <DialogContent className="sm:max-w-[425px]">
                    ...
                    <div className="grid gap-4 mt-2 mb-2">
                        ...
                        <div className="grid gap-3">
                            ...
                            <Select name="corpus">
                                <SelectTrigger className="w-full">
                                    <SelectValue placeholder="Select a corpus (optional)" />
                                </SelectTrigger>
                                <SelectContent>
                                    <SelectItem value="default">Corpus</SelectItem>
                                    <SelectItem value="custom-1">Corpus 1</SelectItem>
                                    <SelectItem value="custom-2">Corpus 2</SelectItem>
                                    <SelectItem value="none">No Corpus</SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
                    </div>
